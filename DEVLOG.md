...
**Mise à jour : Order Oversight + Commission Rules + Escrow Management traduits.** `OrderOversightSection.jsx` (804 lignes), `CommissionRulesManager.jsx` (700 lignes) et `EscrowManagementSection.jsx` (568 lignes) entièrement traduits.
...
- Dashboard admin : restent en anglais — Returned Products, Invoices, Delivery Companies.
